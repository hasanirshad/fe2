    ...
    <main className={styles.swapContainer}>
      ...
      <section className={styles.swapSection}>
        ...
        <div className={styles.swapDetails}>
          <TokenInfo 
            logoSrc="https://cdn.builder.io/api/v1/image/assets/TEMP/7d6a8e649cee81c004c2ac877e69ca79bd49aa26b55bd9d764d32516bad400fe?placeholderIfAbsent=true&apiKey=45ca834082bd4e999875d6aa728b9960" 
            balance="Balance: 0" 
          />
          <img 
      ...
      <form>
        <label htmlFor="amountInput" className={styles['visually-hidden']}>
          Enter an amount
        </label>
        <input 
          type="text" 
