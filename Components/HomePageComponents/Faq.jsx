        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-14">
          <div className="space-y-10">
            <div className="bg-white rounded-lg shadow-md">
              ...
              >
                ...
                <span
                  className="float-right transition-transform duration-200"
                  id="arrow1"
                >
                  ▼
                </span>
              </button>
              <div id="dropdown1" className="hidden px-4 py-2 text-gray-700">
            ...
            <div className="bg-white rounded-lg shadow-md">
              ...
              <div id="dropdown2" className="hidden px-4 py-2 text-gray-700">
            ...
            <div className="bg-white rounded-lg shadow-md">
              ...
              <div id="dropdown3" className="hidden px-4 py-2 text-gray-700">
            ...
            <div className="bg-white rounded-lg shadow-md">
              ...
              <div id="dropdown4" className="hidden px-4 py-2 text-gray-700">
          ...
          <div className="space-y-10">
            <div className="bg-white rounded-lg shadow-md">
              ...
              <div id="dropdown5" className="hidden px-4 py-2 text-gray-700">
            ...
            <div className="bg-white rounded-lg shadow-md">
              ...
              <div id="dropdown6" className="hidden px-4 py-2 text-gray-700">
            ...
            <div className="bg-white rounded-lg shadow-md">
              ...
              <div id="dropdown7" className="hidden px-4 py-2 text-gray-700">
            ...
            <div className="bg-white rounded-lg shadow-md">
              ...
              <div id="dropdown8" className="hidden px-4 py-2 text-gray-700">
